...
@Component({
  ...
  template: `
    <div class="flex flex-col-reverse md:flex-row justify-between md:gap-5">
      <div class="pt-4">
        <h1 class="text-4xl font-bold">Hola, Soy Melchor Ruiz</h1>
        <p class="text-2xl">Desarrollador de software</p>
        <p>Orleans, Centro-Valle del Loira, Francia</p>
        <div class="flex flex-wrap gap-2 py-2 max-w-[400px]">
        ...
        <a href="CV_ES.pdf" target="_blank" class="px-3 py-1 my-1 bg-black text-white flex w-fit font-semibold">
          Currículum
